<template>
    <Layout>
        <!-- Page Title -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Editar Mesa {{ mesa.numero_mesa }}</h1>
            <p class="text-gray-600 mt-2">Modifica la información de la mesa</p>
        </div>
...
const enviarFormulario = () => {
    router.put(`/mesas/${props.mesa.id_mesa}`, formulario, {
        onError: (errors) => {
